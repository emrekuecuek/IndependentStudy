...
# #SBATCH --mem=40000
# #SBATCH --nodelist=it02
# #SBATCH --gres=gpu:1
#SBATCH --time=24:00:00
#SBATCH --output=%j-julia.out
#SBATCH --mail-type=ALL
#SBATCH --mail-user=ekucuk19@ku.edu.tr

INPUT="get_all_scores.jl"
# it should be equal --ntasks-per-node
PARALEL="-t 2"
